      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
          	<h1 class="mb-4">Advanced Image Training for Accurate Dog Breed Classification </h1>
            <p><a href="/hyperparametre/create" class="btn btn-primary mr-md-4 py-3 px-4">Let's Start <span class="ion-ios-arrow-forward"></span></a></p>
          </div>
        </div>
      </div>
    </div>
